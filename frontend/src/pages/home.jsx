...
const areas = [
  ...
  { title: 'Finanzas', tags: ['Aprendizaje', 'Crecimiento'], img: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=60', path: '/searches?area=Pasantia' },
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }} key={i}>
                <motion.div variants={cardVariants} whileHover={{ y: -6 }}>
                  <Card sx={{ p: 3, textAlign: 'center', borderRadius: 3, boxShadow: 3,width: "360px" }} >
                    <v.icon sx={{ fontSize: 60, mb: 1, color: '#0A5C8D' }} />
